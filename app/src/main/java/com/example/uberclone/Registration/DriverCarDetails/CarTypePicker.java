...
import com.example.uberclone.Extras.Adapters.CarAdapter;
...
import com.example.uberclone.Models.Car.UberXL;
    ...
    public void goToCategory(View view){
        if (!category.equalsIgnoreCase("")){
          switch (category){
              ...
              case "UberBlack":
                  Intent toUberBlack = new Intent(CarTypePicker.this, UberBlackDetails.class);
                  toUberBlack.putExtra("driver from picker",nameOfDriver);
                  startActivity(toUberBlack);
                  break;
